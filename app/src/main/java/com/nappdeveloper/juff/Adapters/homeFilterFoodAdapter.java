...
public class homeFilterFoodAdapter extends FirebaseRecyclerAdapter<Model, homeFilterFoodAdapter.Viewholder> {

    private int selected_position = 0;
    public homeFilterFoodAdapter(@NonNull FirebaseRecyclerOptions<Model> options) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull homeFilterFoodAdapter.Viewholder holder, @SuppressLint("RecyclerView") int position, @NonNull Model model) {
    ...
    @NonNull
    @Override
    public homeFilterFoodAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        //the data objects are inflated into the xml file single_data_item
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_filter_layout, parent, false);
        return new homeFilterFoodAdapter.Viewholder(view);
