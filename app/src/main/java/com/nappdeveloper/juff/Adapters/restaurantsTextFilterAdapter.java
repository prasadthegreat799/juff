...
public class restaurantsTextFilterAdapter extends FirebaseRecyclerAdapter<Model, restaurantsTextFilterAdapter.Viewholder> {

    private int selected_position = 0;
    public restaurantsTextFilterAdapter(@NonNull FirebaseRecyclerOptions<Model> options) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull restaurantsTextFilterAdapter.Viewholder holder, @SuppressLint("RecyclerView") int position, @NonNull Model model) {
    ...
    @NonNull
    @Override
    public restaurantsTextFilterAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        //the data objects are inflated into the xml file single_data_item
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurants_text_filter_layout, parent, false);
        return new restaurantsTextFilterAdapter.Viewholder(view);
    ...
    class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            linearLayout = (CardView) itemView.findViewById(R.id.restaurant_text_filter_card);
            filterNameTxt = (TextView) itemView.findViewById(R.id.restaurants_filter_text);
